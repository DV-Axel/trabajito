...
const ViewShowRequest = () => {
    ...
    return (
        <div className="max-w-2xl mx-auto mt-8 bg-white rounded-lg shadow-lg p-6">
            ...
            <button
                className="bg-[#02283A] text-white px-6 py-2 rounded-full font-semibold mt-4 w-full"
                onClick={handleAbrirPostular}
            >
                Postularse
            </button>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
                    <div className="bg-white p-6 rounded shadow-lg max-w-sm w-full flex flex-col items-center">
                        <h3 className="text-lg font-bold mb-4 text-gray-800 text-center">
                            ¿Cuál crees que sería un presupuesto mínimo/estimado para este trabajo?
                        </h3>
                        <input
                            type="number"
                            min="0"
...
export default ViewShowRequest;
